...
dataloader.train.dataset.names = "uxo_11_1channel_fair_train"
dataloader.test.dataset.names = "uxo_11_1channel_fair_valid"
...
train.eval_period = 5000
train.output_dir = "./output/dino_r50_custom_fair/"
