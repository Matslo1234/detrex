...
dataloader.train.dataset.names = "uxo_11_fair_train"
dataloader.test.dataset.names = "uxo_11_fair_valid"
...
train.output_dir = "./output/dino_r50_4scale_12ep_300dn_fair"
