...
dataloader.train.dataset.names = "uxo_11_1channel_train"
dataloader.test.dataset.names = "uxo_11_1channel_valid"
dataloader.test.mapper.augmentation = []
dataloader.test.mapper.augmentation_with_crop = []
...
train.output_dir = "./output/dino_r50_custom/"
